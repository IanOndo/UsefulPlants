...
Here, we are going to use the outputs of the modelling of @UsefulPlants, which can be downloaded from its Zenodo repository at [**https://doi.org/10.5281/zenodo.10345634**](https://doi.org/10.5281/zenodo.10345634). Download the dataset, unzip it and save the file `species_proba_per_cell.rds` somewhere on your computer, then load it into R:
...
# fill up raster values with corresponding estimates
predicted_weighted_endemism[weighted_endemism[['cell']][valid.cells]] <- 
  weighted_endemism[['WE']][valid.cells]
