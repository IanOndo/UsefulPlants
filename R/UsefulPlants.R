#' Utilised plant species data
#'
#' List of plant species used by humans
#'
...
#'   \item{Totals}{total number of uses reported for a species}
#'
#' }
#' @source \url{https://zenodo.org/record/8176318}
#' @name usefulplants
NULL
